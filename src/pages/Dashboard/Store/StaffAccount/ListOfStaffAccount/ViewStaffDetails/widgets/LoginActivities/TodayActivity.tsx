     ...
     {!isLoading && <Accordion
      ...
      >
        ...
        <AccordionDetails>
          ...
          {(activities && activities.length) ? activities?.map((item: any) =>  <div className="login-activities">
              <div>{item?.description}    {moment(item?.created_at).format("MM/DD/YYYY [at] h:mma")}</div>
            </div>
