...
type propType = {
  ...
  closeModal: () => void;
  id: any;
  handlePaymentSettlement: (val: any) => void;
};
      ...
      <ModalBottom closeModal={closeModal} openModal={openModal}>
        <div className="pd_share_invoice_modal">
          <div className="order_container-ig">
            <ModalHeader text="Request Payment" closeModal={closeModal} />
          ...
          {openModal && (
            <SendPaymentModal
              ...
              closeShowPaymentModal={() => setShowPayment(false)}
              selected={selectedOrder[selectedOrder?.length - 1]}
